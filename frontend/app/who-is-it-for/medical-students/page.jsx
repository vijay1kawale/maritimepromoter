...
const content = whoIsItForContent.medicalStudents;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <GraduationCap size={24} className="text-eco-green-4" />
                <span className="text-eco-green-4 font-medium">Medical Students</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Comprehensive support and training programs designed specifically for medical students.
            </p>
          </div>
      ...
      <section ref={servicesRef} id="services" className="bg-gray-50 dark:bg-gray-800 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Detailed services designed to support your medical education journey.
            </p>
          </div>
      ...
      <section ref={testimonialsRef} className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Hear from medical students who have benefited from our programs.
            </p>
          </div>
