...
const content = whoIsItForContent.labs;
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <Microscope size={24} className="text-eco-green-4" />
                <span className="text-eco-green-4 font-medium">Labs</span>
              </div>
              ...
              <div className="bg-gradient-to-br from-eco-green-4 to-eco-green-4 rounded-2xl p-8 text-white">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-white">Labs Set Up</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold mb-2">100%</div>
                    <div className="text-white">NABL Success</div>
                  </div>
                  <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Specialized solutions designed specifically for laboratory setup, accreditation, and management.
            </p>
          </div>
      ...
      <section ref={servicesRef} id="services" className="bg-gray-50 dark:bg-gray-800 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Detailed services designed to support your laboratory from setup to operational excellence.
            </p>
          </div>
      ...
      <section ref={testimonialsRef} className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              What Our Lab Directors Say
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Hear from lab directors who have achieved excellence with our support.
            </p>
          </div>
