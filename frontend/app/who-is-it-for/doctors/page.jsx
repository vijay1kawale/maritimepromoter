...
const content = whoIsItForContent.doctors;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <Users size={24} className="text-eco-green-4" />
                <span className="text-eco-green-4 font-medium">Doctors</span>
              </div>
              ...
              <div className="bg-gradient-to-br from-eco-green-4 to-eco-green-4 rounded-2xl p-8 text-white">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-white">Doctors Served</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold mb-2">300%</div>
                    <div className="text-white">Avg. Revenue Growth</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold mb-2">50+</div>
                    <div className="text-white">Practice Setups</div>
                  </div>
                  <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Comprehensive support and growth solutions designed specifically for practicing doctors.
            </p>
          </div>
      ...
      <section ref={servicesRef} id="services" className="bg-gray-50 dark:bg-gray-800 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Detailed services designed to support your medical practice growth.
            </p>
          </div>
      ...
      <section ref={testimonialsRef} className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Hear from doctors who have transformed their practices with our support.
            </p>
          </div>
